...
county_state_crosswalk = pd.read_excel(f'{raw_data}/county_msa_crosswalk_raw.xlsx', 
...
county_state_crosswalk.to_csv(f'{clean_data}/county_msa_crosswalk_cleaned.csv', 
                              index=False)
...
county_fips_crosswalk.to_csv(f'{clean_data}/county_fips_crosswalk_clean.csv', index=False)